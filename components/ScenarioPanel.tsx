...
const SCENARIOS = [
  {
    ...
    label: "Escalating",
    descriptor: "Steady risk build-up across domains",
  },
  {
    id: "SCENARIO_CRITICAL",
    label: "Critical",
    descriptor: "Rapid escalation to assignment blocker",
  },
] as const;
  ...
  return (
    <aside className="flex flex-col gap-4 p-4 h-full overflow-y-auto">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
        <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Assignment</div>
        {employee ? (
          <>
